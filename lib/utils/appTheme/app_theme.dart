...
class AppTheme {
  ...
  // Therapeutic Serenity Color Palette
  static const Color primaryLight = Color(0xFF2E7D32); // Deep therapeutic green
  static const Color primaryVariantLight =
      Color(0xFF1B5E20); // Darker green variant
  static const Color secondaryLight =
      Color(0xFF66BB6A); // Lighter green for secondary actions
  static const Color secondaryVariantLight = Color(0xFF4CAF50); // Success green
  ...
  static const Color accentLight =
      Color(0xFFFF8A65); // Warm coral for achievements
  static const Color successLight = Color(0xFF4CAF50); // Clear success green
  static const Color warningLight = Color(0xFFFFC107); // Gentle amber
  ...
  // Dark theme accent and status colors
  ...
  static const Color borderLight = Color(0xFFE0E0E0); // Gentle definition
  ...
  /// Light theme with Contemporary Medical Minimalism design
  static ThemeData lightTheme = ThemeData(
    ...
    // Card theme with subtle elevation for contextual cards
    cardTheme: CardTheme(
      color: cardLight,
      elevation: 2.0,
      shadowColor: shadowLight,
      shape: RoundedRectangleBorder(
        borderRadius:
            BorderRadius.circular(12.0), // Approachable professionalism
      ),
      margin: const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
    ),

    // Bottom navigation for healthcare practitioners
    ...
    // Button themes with professional warmth
    ...
    // Progress indicator for health tracking
  ...
  /// Dark theme with Contemporary Medical Minimalism design
